        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Deposite</h4>
...
if(isset($_POST['submit']))
{
  ...
  $edate=$_POST['edate'];
                      ...
                      <form action="adeprt.php" method="POST" >
            <div class="row">
                        <div class="row mb-3">
...
<div class="card">
                <h5 class="card-header">Deposite Details</Table></h5>
                <div class="card-body">
...
<?php 
  ...
  $i=1;
  $stmt=$admin->ret("SELECT * FROM `deposite` INNER JOIN `acust` ON  deposite.cid=acust.cid WHERE deposite.ddate BETWEEN '$sdate' AND '$edate' ");
