                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <form action="../../controller/addcustomer1.php" method="POST" enctype="multipart/form-data" novalidate>
            <div class="row mt-5">
                        <div class="row mb-3">
                  ...
                  * Valid  Address is required.
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                              <input type="tel" name="phone" class="form-control" id="basic-default-name" required  pattern="['0-9]{10}" />
                              <div class="invalid-feedback">
                    * Valid  Phone Number is required.
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="email" name="email" class="form-control" id="basic-default-name" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"/>
                                <div class="invalid-feedback">
                  * Valid  Email is required.
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="number" name="age" class="form-control" id="basic-default-name" required />
                            <div class="invalid-feedback">
                  ...
                  * Valid  Adhar Number is required.
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" pattern="['0-9]{13}" name="acno" class="form-control" id="basic-default-name" required />
                            <div class="invalid-feedback">
